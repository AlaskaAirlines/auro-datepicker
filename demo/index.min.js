...
class RangeDatepickerCalendar extends r$2 {
  ...
  handlePrevMonth() {
    ...
    monthName === null || monthName === void 0 ? void 0 : monthName.classList.add('moveToRight');
    const month = parse(this.month, 'MM', new Date());
    const monthMinusDate = subMonths(month);
    ...
    if (this.month === '12') {
      const year = parse(this.year.toString(), 'yyyy', new Date());
      const yearMinusDate = subYears(year);
...
var tokensCss$4 = i$5`:host{--ds-auro-icon-color:var(--ds-color-icon-primary-default, #676767);--ds-auro-icon-size:var(--ds-size-300, 1.5rem)}`;
